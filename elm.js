...
var _user$project$Component_Types$Post = F4(
	function (a, b, c, d) {
		return {title: a, content: b, slug: c, created: d};
	});
var _user$project$Component_Types$createPost = F4(
	function (title, content, slug, created) {
		return A4(
			_user$project$Component_Types$Post,
			title,
			content,
			slug,
			_elm_lang$core$Result$toMaybe(
				_elm_lang$core$Date$fromString(created)));
	});
var _user$project$Component_Types$postDecoder = function () {
	var created = A2(_elm_lang$core$Json_Decode_ops[':='], 'created', _elm_lang$core$Json_Decode$string);
	...
	return A5(_elm_lang$core$Json_Decode$object4, _user$project$Component_Types$createPost, title, content, slug, created);
}();
					...
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								...
								_elm_lang$core$Native_List.fromArray(
									[
										_elm_lang$html$Html_Attributes$class('page-title')
									]),
								_elm_lang$core$Native_List.fromArray(
									[
										_elm_lang$html$Html$text('LATEST POSTS')
									]))
							]))
					])),
				_circuithub$elm_bootstrap_html$Bootstrap_Html$row_(
			...
			default:
				var navigate = _elm_lang$navigation$Navigation$newUrl(
					_user$project$Router$toHash(
						_user$project$Router$PostPage(_p1._0)));
...
var _user$project$Component_Header$view = function (model) {
	var logo = A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$src('assets/images/logo-retina@2x.png'),
				_elm_lang$html$Html_Attributes$height(100)
			]),
		_elm_lang$core$Native_List.fromArray(
			[]));
	var title = A2(
							...
							[
								...
								_elm_lang$core$Native_List.fromArray(
									[
										...
										_elm_lang$core$Native_List.fromArray(
											[
												_elm_lang$html$Html_Attributes$class('logo-image')
											]),
										_elm_lang$core$Native_List.fromArray(
											[logo])),
										A2(
